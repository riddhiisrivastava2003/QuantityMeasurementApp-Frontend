...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    // FIX: Ensure https:// is present — Vercel env var might be set without protocol
    let authServiceUrl = import.meta.env.VITE_AUTH_SERVICE_URL || 'https://auth-service-production-4ffe.up.railway.app'
    if (!authServiceUrl.startsWith('http')) {
